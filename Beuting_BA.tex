...
\begin{titlepage}
  ...
  \begin{center}
    ...
    Matrikelnummer: {\color{change}7732108}\[1ex]
  ...
  \small
  Hamburg, am {\color{change} 22.04.2026} %\today
  \vspace*{-15mm}
\end{titlepage}
...
% Ich erkl"are an Eides statt, dass ich die vorliegende Bachelorarbeit selbstst"andig und ohne fremde Hilfe verfasst, andere als die angegebenen Quellen und Hilfsmittel nicht benutzt bzw. die w"ortlich oder sinngem"a{	tfamily ss} entnommenen Stellen als solche kenntlich gemacht habe.
...
\item z.B. \emph{Diese Arbeit orientiert sich am Artikel von...} oder \emph{Diese Arbeit ist eine Ausarbeitung/Verallgemeinerung des Artikels von...}
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Hier beginnt die Arbeit, hallpohallohalooo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item Wesentlich ist, dass Sie die benötigte Notation \emph{eindeutig} einführen. Verwenden Sie z.B. \emph{entweder} $W^{1,2}()\emph{ oder} H^1()$ für den Sobolev-Raum.
\end{itemize}
}
...
\item Nur wichtige Formeln kriegen eine Nummer. Das sind üblicherweise Formeln in Sät- ten, Lemmata etc. sowie Formeln, auf die Sie im Beweis referenzieren.
...
dden Abschnitt an. Häufig ist es besser, Abschnitte zu zitieren als Seitennummern.
...
\item Die \verb$BibTeX$-Einträge können Sie aus \verb$http://www.ams.org/mathscinet/$ mittels Copy'n'Paste überneh- men.\n\item Auch wenn Sie die \verb$BibTeX$-Einträge aus \verb$http://www.ams.org/mathscinet/$ übernehmen, sollten Sie darauf achten, dass am Ende die Einträge \emph{einheitlich} sind:
\begin{itemize}
