...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vskip 8mm
    {\huge\bfseries\color{change}Wavelettransformation of EKG signals \\[1ex] ggf.\ mehrzeilig}
    \vskip 1cm
    \large 
    ausgef\"uhrt am    
    \vskip 0.75cm
...
Grundlage Signalanalyse, Wie ensteht rasuchen? warum will man das vermeiden? Beide Methoden kurz anreißen. 
%\\ Literatur: 
\\
...
\\ 3.3 Angewendet auf EKG Signal - hier python code selbst implementieren 
\\
\\ Literatur: 
\\
\\  4. wavelets 
...
\\ 4.3 Angewendet auf EKG Signal - hier python code selbst implementieren 
\\ Literatur: Ingrid Daubechies: Ten lectures on wavelets.
\\
\\  5. vergleich der beiden Methoden 
\\ Vor und Nachteile, Beobachtungen, Grenzen was geht immer noch nicht?
\\ Literatur: 
\\
\\
\\  6. conclusion
