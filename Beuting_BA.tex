...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vskip 8mm
    {\huge\bfseries\color{change}Adaptive Wavelet Galerkin Methods \\[1ex] ggf.\ mehrzeilig}
    \vskip 1cm
    \large 
    ausgef\"uhrt am    
    \vskip 0.75cm
    ...
    \vskip0.75cm
    {\Large\bfseries\color{change}Philip Lukas Lederer}\\[1ex]
    \vskip 0.5cm
    durch
    \vskip 0.5cm
...
\\
\\ Thema: Adaptive wavelet Galerkin Methods - angewandt dann auf ein Beispiel wo das besonders gut funktioniert
\\
\\ 1. Einleitung 
\\ evtl konkrete PDE vorstellen, bei der klassische Verfahren Probleme haben - lokale Singularitäten oder starke Gradienten - "gleichmäßige Gitter verschwenden Rechenkapazität dort, wo die Lösung glatt ist "  => Wavelets als Lösung davon (kleiner Träger), Galerkin macht was eigentlich?
%\\ Literatur: 
\\
\\  2. mathematische Grundlagen 
\\ PDEs, Räume definieren, wichtige sachen die ich nicht kenne - wenn ich anfange zu verstehen
%\\ Literatur: 
\\
\\  3. Galerkin methods bzw. adaptive galerkin methods 
\\ ? noch nicht richtig gecheckt - motivation klarmachen - maybe mit beispiel was ist unterschied adaptive und nicht...
\\ Literatur: Cockburn, Karniadakis, Shu - Discontinous Galerkin Methods
\\
\\  4. wavelets 
\\ intuition, definition, kleiner träger - unterschied fourier, vorteile, daubechies wavelets
\\ Literatur: Ingrid Daubechies: Ten lectures on wavelets.
\\
\\  5. connecten 
\\ also adaptive wavelet galerkin methods - warum kombi so gut? - was heisst so gut? 
\\ Literatur: DeVore, Kunoth - Multiscale, Nonlinear and adaptive Approximation p. 249 - 294; Cohen, Hoffmann, Reiß - Adaptive wavelet galerkin methods for linear inverse Problems
\\
\\  6. Beispiel 
\\ wann funktioniert das besonders gut? - ohne wavelets vll schlechtere lösung, ein Beispiel finden (1D Poission??) 
\\
\\  7. conclusion
...
\item Laut Studienplan\footnote{\href{https://www.uni-hamburg.de/campuscenter/studienorganisation/ordnungen-satzungen/pruefungs-studienordnungen/mathematik-informatik-und-naturwissenschaften/20250521-fsb-min-bsc-mathe-55.pdf}{\ttfamily uni-homepage}}
gilt:
\begin{quote}\itshape
  Die Bachelorarbeit dient dazu, die Studierenden in das selbstständige wissenschaftliche Arbeiten einzuführen. Dabei sollen die Studierenden das im Studium erworbene Wissen und die erworbene Methodenkompetenz einsetzen, um zu einer mathematischen Problemstellung Lösungen oder Lösungsansätze gemäß den üblichen wissenschaftlichen Standards schriftlich zu dokumentieren.
\end{quote}
...
werden 12 ECTS-Punkte. Beachten Sie insbesondere, dass das
